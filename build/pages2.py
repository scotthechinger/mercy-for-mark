...
<article class="chapter" id="jury">
  ...
  <div class="splitmedia">
    ...
    <figure class="fill">
      <div class="placeholder" style="height:100%;min-height:290px;display:flex;
        flex-direction:column;align-items:center;justify-content:center">
        <b>Richard Spiker's recording to come</b>
        <span>The juror speaking, with a transcript.</span>
      </div>
