...
<footer class="foot"><div class="wrap">
  ...
  <div><h4>Take action</h4><ul>
    ...
    <li><a href="postcards.html">The postcard project</a></li>
...
<section class="band"><div class="wrap">
  <div style="text-align:center;max-width:760px;margin:0 auto">
    ...
    <p class="lede measure" style="margin:0 auto">Four things you can do, none of
    them difficult.</p>
  </div>
  <div class="cards four" style="margin-top:38px">
    ...
    <article class="card"><span class="n">Three</span><h3>Send a postcard</h3>
      <p>People of faith across Alabama are answering one question in their own
      handwriting and mailing it to Montgomery.</p>
      <a class="textlink" href="postcards.html">See the cards</a></article>
    <article class="card"><span class="n">Four</span><h3>Get updates</h3>
